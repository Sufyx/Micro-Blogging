...
export default function CreateTweet() {
  ...
  return (
    <>
      ...
      <div className="displayFilter btn btn-primary" onClick={displayChange} disabled={filterDisabled}>
        <span className="displayFilterMessage" disabled={filterDisabled}>
          Showing <span className="filterModeText" disabled={filterDisabled}>{showOnlyUser ? 'Your Tweets' : 'All Tweets'}</span>. Click to change to {showOnlyUser ? 'All Tweets' : 'Your Tweets'}
        </span>
      </div>
    </>
  )
